...
deepspeed adpt_finetune.py --from_pretrained google/flan-t5-xl --dataset medqa_d2n --model_type adapter --max_steps 10000 --eval_steps 500 --batch_size 1 --grad_steps 1 --weight 1 --alpha 0.8 --addi_info distill_adpt_xl_r8 --bf16 --parallelize --deepspeed configs/ds_config_zero2.json
