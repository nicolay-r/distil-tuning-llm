...
deepspeed adpt_finetune.py --from_pretrained google/flan-t5-small --dataset medqa_d2n --model_type adapter --max_steps 500 --eval_steps 2 --batch_size 1 --grad_steps 1 --weight 1 --alpha 0.5 --addi_info distill_adpt --deepspeed configs/ds_config_zero2.json
