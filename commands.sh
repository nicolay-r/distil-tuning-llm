...
CUDA_VISIBLE_DEVICES=0 deepspeed distill_finetune.py --from_pretrained google/t5-v1_1-small --dataset medqa_d2n --model_type task_prefix --eval_steps 5 --batch_size 8 --grad_steps 2 --alpha 0.7 --addi_info pred_7_3 --deepspeed configs/ds_config_zero2.json
...
Distill finetuning:
python distill_finetune.py --from_pretrained google/t5-v1_1-small --dataset medqa_d2n --model_type task_prefix --eval_steps 5 --batch_size 2 --grad_steps 2 --addi_info pred_7_3
...
Distill Inference:
python inference.py --from_pretrained google/t5-v1_1-small --dataset medqa_d2n --model_type task_prefix --addi_info pred_6_4 --best_step 10000
