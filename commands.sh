...
python distill_finetune.py --from_pretrained google/t5-v1_1-base --dataset medqa_d2n --model_type task_prefix --eval_steps 50 --batch_size 2 --grad_steps 2 --addi_info pred_1000
...
Distill Inference:
python inference.py --from_pretrained google/t5-v1_1-small --dataset medqa_d2n --model_type task_prefix --addi_info pred_1000 

Sft inference:
python inference.py --from_pretrained google/t5-v1_1-small --dataset medqa_d2n --model_type standard --best_step 900
