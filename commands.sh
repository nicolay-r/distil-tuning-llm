...
deepspeed distill_finetune.py --from_pretrained google/flan-t5-large --dataset medqa_d2n --model_type task_prefix --eval_steps 200 --batch_size 1 --grad_steps 2 --weight 1000 --addi_info large_200 --deepspeed configs/ds_config_zero2.json

deepspeed distill_finetune.py --from_pretrained google/flan-t5-small --dataset medqa_d2n --model_type task_prefix --eval_steps 50 --batch_size 4 --grad_steps 1 --weight 1000 --addi_info flan --deepspeed configs/ds_config_zero2.json
