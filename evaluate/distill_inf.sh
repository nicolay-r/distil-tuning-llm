...
OUTPUT_DIR="./results/xiao_28_18000"
# /root/distill-d2n/ckpts/task_prefix/flan-t5-large_dstl_xl/checkpoint-250/pytorch_model.bin
CKPT_DIR="../ckpts/task_prefix/flan-t5-large_MeDistill_28_hierarchical_ep30/checkpoint-18000/"
# /root/distill-d2n/ckpts/task_prefix/flan-t5-large_MeDistill_28_hierarchical_ep30/checkpoint-9600/trainer_state.json
