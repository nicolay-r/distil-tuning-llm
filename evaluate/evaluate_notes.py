...
def main(
    ...
    #     },
    # )["train"]
    csv_path = f"{references_fp}/generated_predictions_df.csv"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--references_fp', required=True, help='filename of gold references requires id and note column.')
    parser.add_argument('--task', required=True, help='filename of gold references requires id and note column.')
    parser.add_argument('--cache_dir', required=True, help='filename of gold references requires id and note column.')
    
    
    args = parser.parse_args()
    main(args.references_fp, args.task, args.cache_dir)